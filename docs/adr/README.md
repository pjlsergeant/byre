...
- 0052: a mount/volume over a byre-managed path gets ONE blanket containment disclosure, skills included and attributed; no per-claim degradation, and `files` keeps its granular reporting [arm: TestManagedPathShadows, TestRenderStatusManagedShadowDisclosure]
