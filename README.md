...
tldr: `byre completion <your-shell>` prints the script.

Completions cover every command and flag, generated by byre itself — bash,
zsh, fish, and powershell. Run `byre completion zsh --help` (or your
shell's) for the exact line to add to your shell config.
