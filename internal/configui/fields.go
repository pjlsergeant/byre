...
var fieldInfos = map[fieldID]fieldInfo{
	...
	fVolumes: {label: "Volumes", kind: kindList, item: "Volume", noun: "volume",
		explain: "named storage that survives rebuilds — skills declare most of them"},
	fVolumeData:      {label: "Volume data"},
