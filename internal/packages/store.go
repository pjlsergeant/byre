...
// package tree and lay a generated header below the body's leading bare
// keys (HeaderAfterPreamble).
//
...
// would land over a file that still declares its own [package] -- and that
// is a defect in this repo's own skills, caught by the builtins golden tests
// long before a mirror is written.
