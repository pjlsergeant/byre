...
// generatedMarkerRe recognizes the marker at the head of one of byre's
// own comment forms. Anchored at both ends: a bare Contains would claim
// any file that merely mentions the phrase as byre-owned and overwrite
// it, and an unbounded tail would claim a "Generated by byrederivative"
// lookalike. Every generation, legacy included, has begun a header
// comment this way, phrase followed by a period.
var generatedMarkerRe = regexp.MustCompile(`(?m)^(?:-- |# |<!-- )Generated by byre\.`)
